...
function buildBindings(cfg) {
  ...
  _lodash2.default.forOwn(cfg, function (value, key) {
    ...
    var b = new MyBinding(schema);
    _lodash2.default.forOwn(b.mutation, function (resolve, field) {
      b.mutation[field] = function (args, context, info) {
        if (args.input) {
    ...
    binding['binding'] = _extends({}, binding['binding'], _defineProperty({}, key, b));
  });
