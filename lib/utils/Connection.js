...
var sqlResolve = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(sequelize, modelName, args) {
    var after, first, before, last, conditionSql, orderBySql, replacements, count, offset, result, index, startCursor, endCursor;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            offset = Math.max(after != null ? parseInt(after) : 0, 0);
            _context2.next = 10;
            return sequelize.query('select ' + modelName + '.* ' + conditionSql + ' ' + orderBySql + ' LIMIT ' + first + ' OFFSET ' + offset, {
