              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return _context2.abrupt('return', relay.toGlobalId(fieldType.name.substr(0, fieldType.length - 'Id'.length), root[fieldName]));
        ...
        fields: function fields() {
          ...
          _lodash2.default.forOwn(fieldType, function (value, key) {
            if (value['$type'] && value['hidden']) {} else {
              if (remoteWithId && !value.isLinkField && value['$type'] instanceof _RemoteSchema2.default) {
