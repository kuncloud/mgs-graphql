      ...
      return {
        ...
        resolve: function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(root) {
            var fieldName, linkId;
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    fieldName = name.split('.').slice(-1)[0];
                    linkId = fieldName.endsWith('Id') ? fieldName : fieldName + 'Id';
                    ...
                    return _context2.abrupt('return', relay.toGlobalId(fieldType.name.substr(0, fieldType.name.length - 'Id'.length), root[linkId]));
        ...
        fields: function fields() {
          ...
          _lodash2.default.forOwn(fieldType, function (value, key) {
            if (value['$type'] && value['hidden']) {} else {
              ...
              (0, _invariant2.default)(!fields[key], 'duplicate key exist in schema:may be auto generated key:' + name + ' ' + fieldType.name + ':' + key + ' ' + value);
