...
var _ModelRef = require('../definition/ModelRef');
...
var toGraphQLFieldConfig = function toGraphQLFieldConfig(name, postfix, fieldType, context) {
  ...
  if (fieldType instanceof _ModelRef2.default) {
    ...
    return {
      type: _type2.default.GraphQLScalarTypes.globalIdInputType(fieldType.name),
      resolve: context.wrapFieldResolve({
        name: name.split('.').slice(-1)[0],
        path: name,
        $type: _type2.default.GraphQLScalarTypes.Json,
        resolve: function () {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 7:
                    ...
                    return _context2.abrupt('return', sgContext.service[fieldType].findOne({ where: { id: root[fieldName] } }));
          ...
          function resolve(_x7, _x8, _x9, _x10, _x11) {
      ...
      return {
        ...
        resolve: context.wrapFieldResolve({
          ...
          resolve: function () {
            ...
            function resolve(_x13, _x14, _x15, _x16, _x17) {
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      return _context5.abrupt('return', root[name.split('.').slice(-1)[0]]);
