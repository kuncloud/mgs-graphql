...
var toGraphQLFieldConfig = function toGraphQLFieldConfig(name, postfix, fieldType, context) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return sgContext.models[fieldType[0]].findAll({ where: { id: { $in: root[fieldName] } } });
  ...
  if (fieldType instanceof _RemoteSchema2.default) {
    ...
    // console.log(obj)
    return { type: _type2.default.GraphQLScalarTypes.globalIdInputType(fieldType.name) };
    // return {
    ...
    //         )) {
    //         return sgContext.services[fieldType].findOne({where: {id: root[fieldName]}})
    //       }
    //       return root[fieldName]
    //     }
    //   })
    ...
    if (fieldType.endsWith('Id')) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return _context2.abrupt('return', relay.toGlobalId(fieldType.substr(0, fieldType.length - 'Id'.length), root[fieldName]));
      ...
      return {
        ...
        resolve: context.wrapFieldResolve({
          ...
          $type: context.graphQLObjectType(fieldType),
          resolve: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(root, args, context, info, sgContext) {
              var fieldName;
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 7:
                      ...
                      return _context3.abrupt('return', sgContext.models[fieldType].findOne({ where: { id: root[fieldName] } }));
            ...
            function resolve(_x8, _x9, _x10, _x11, _x12) {
