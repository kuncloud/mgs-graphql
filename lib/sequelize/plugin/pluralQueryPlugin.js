        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
                ...
                _.forOwn(schema.config.fields, function (value, key) {
                  if (typeof value === 'string' || value && typeof value.$type === 'string') {
                    if (typeof condition[key] !== 'undefined') {
                      ...
                      if (!condition[_sequelize2.default.Op.eq]) {
                        condition[_sequelize2.default.Op.eq] = [];
                      }
                      Object.keys(condition[key]).forEach(function (f) {
                        if (dbModel.options.underscored) {
                          condition[_sequelize2.default.Op.eq].push(_sequelize2.default.where(_sequelize2.default.col(key + '.' + _StringHelper2.default.toUnderscoredName(f)), _defineProperty({}, _sequelize2.default.Op.eq, condition[key][f])));
                        } else {
                          condition[_sequelize2.default.Op.eq].push(_sequelize2.default.where(_sequelize2.default.col(key + '.' + f), _defineProperty({}, _sequelize2.default.Op.eq, condition[key][f])));
                        }
                      });
                ...
                for (_iterator2 = fields[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  ...
                  if (field.indexOf('.') !== -1) {
                    ...
                    if (type) {
                      ...
                      keywordsCondition.push(_sequelize2.default.where(_sequelize2.default.col(colFieldName), _defineProperty({}, _sequelize2.default.Op.like, '%' + value + '%')));
                    } else {
                      keywordsCondition.push(_defineProperty({}, field, _defineProperty({}, _sequelize2.default.Op.like, '%' + value + '%')));
                    }
                  } else {
                    keywordsCondition.push(_defineProperty({}, field, _defineProperty({}, _sequelize2.default.Op.like, '%' + value + '%')));
                  }
              ...
              case 49:
                condition[_sequelize2.default.Op.or] = keywordsCondition;
